...
<header class="header black-bg">
    ...
    <!--logo start-->
    <a href="${pageContext.request.contextPath}/" class="logo"><b>DASH<span>IO</span></b></a>
    <!--logo end-->
    ...
    <div class="top-menu">
        <ul class="nav pull-right top-menu">
            <li><a class="logout" href="${pageContext.request.contextPath}/us?action=logout">Logout</a></li>
        </ul>
    </div>
</header>
<!--header end-->
